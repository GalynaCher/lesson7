...
public class Main {
    public static void main(String[] args) {
        ...
        if (isInteger) {
            ...
            if (isNegative) {
                ...
                System.out.println("Value is between 1-50");
            } else if (intVal <= 100) {
                System.out.println("Value is between 50-100");
        ...
        System.out.println("Divider: " + divider + " - " + ((float) (isInteger ? Integer.parseInt(strNum) : 100) / divider));
    ...
    static private boolean isInteger (String  value){
